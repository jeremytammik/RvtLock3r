...
namespace RvtLock3r
{
    internal class NamedGroundTruthStorage
    {
        ...
        public static void ReadFromDataStorage()
        {
            Entity entity = dataStorage.GetEntity(NamedGroundTruthSchema.GetSchema(false));
            ...
            if (entity.IsValid())
            {
                String ElementTypeId = entity.Get<string>("GroundTruth");

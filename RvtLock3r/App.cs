...
namespace RvtLock3r
{
  class App : IExternalApplication
  {
    ...
    public static void RegisterWallUpdater(UIControlledApplication app)
    {
      ...
      ParamValueValidator wallUpdater = new ParamValueValidator(app.ActiveAddInId);
      ...
      ElementFilter filter = new ElementIdSetFilter(ids);
  ...
  public class UIDynamicModelUpdateOff : IExternalCommand
  {
    public Result Execute(
      ...
      ElementSet elements)
    {
      ParamValueValidator.m_updateActive = false;
      return Result.Succeeded;
    }
  ...
  public class UIDynamicModelUpdateOn : IExternalCommand
  {
    public Result Execute(
      ...
      ElementSet elements)
    {
      ParamValueValidator.m_updateActive = true;
      return Result.Succeeded;
    }
  }
}

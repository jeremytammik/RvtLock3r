...
namespace RvtLock3r
{
  ...
  {
    /// <summary>
    /// Return string representation of the Ground Truth triples to be stored
    /// </summary>
    ...
    /// </summary>
    /// Computes a checksum or the given string
    /// </summary>
    ...
    /// </summary>
    /// Return a set of altered elements from the dictionary of validation errors
    /// </summary>
